    ...
    return <form className="border rounded-md p-6 shadow-sm flex flex-col gap-5 h-fit">
        ...
        <div className="grid grid-cols-12 gap-4">
            ...
            <fieldset className="grid grid-cols-1 gap-1 text-sm col-span-5">
                <label className="font-medium truncate max-w-36" htmlFor="subtype">Unidad de medida</label>
        ...
        <div className="grid grid-cols-12 gap-4">
            <fieldset className="grid grid-cols-1 gap-1 text-sm col-span-6">
                <label className="font-medium" htmlFor="subtype">Tipo</label>
            ...
            <fieldset className="grid grid-cols-1 gap-1 text-sm col-span-6">
                <label className="font-medium" htmlFor="category_id">Categoría</label>
        ...
        <div className="grid grid-cols-12 gap-4">
            ...
            <fieldset className="grid grid-cols-1 gap-1 text-sm col-span-5">
                <label className="font-medium truncate line-clamp-1" htmlFor="status">Estado</label>
        ...
        <div className="grid grid-cols-12 gap-4 border-t pt-6 mt-2 border-dashed">
            <fieldset className="grid grid-cols-1 gap-1 text-sm col-span-5">
                <label className="font-medium truncate line-clamp-1" htmlFor="price">Precio</label>
            ...
            <fieldset className="grid grid-cols-1 gap-1 text-sm col-span-7">
                <label className="font-medium truncate line-clamp-1 flex items-center gap-2" htmlFor="cost">Costo <QuestionCircle /></label>
                <div className="flex items-center gap-2">
                    <CurrencySymbol />
        ...
        <div className="grid grid-cols-12 gap-4">
            <fieldset className="flex items-center gap-2 text-sm col-span-7">
                ...
                <label className="font-medium cursor-pointer" htmlFor="taxable">Afecto a impuestos</label>
            </fieldset>
        </div>
        <div className="grid grid-cols-12 border-t pt-6 mt-2 border-dashed">
            <fieldset className="grid grid-cols-1 col-span-5 gap-1 text-sm">
                <label className="font-medium flex items-center gap-2" htmlFor="waste">Merma <QuestionCircle /></label>
                <div className="flex items-center gap-2">
                    <span>%</span>
            ...
            <fieldset className="grid grid-cols-1 col-span-7 gap-1 text-sm">
                <label className="font-medium flex items-center gap-2" htmlFor="clean-cost">Costo sin merma <QuestionCircle /></label>
                <div className="flex items-center gap-2">
                    <CurrencySymbol />
